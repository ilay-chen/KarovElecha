...
/**
 * Created by עילאי חן on 19 נובמבר 2016.
 */
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        editor.putString(getString(R.string.notificationData),oldData + remoteMessage.getNotification().getBody() + "D");
        //editor.putString(getString(R.string.silence), "true,10:30,1-2-3,true=1,false,true|");
        editor.commit();

        sendNotification(remoteMessage.getNotification().getBody(), remoteMessage.getData().get("test"));
