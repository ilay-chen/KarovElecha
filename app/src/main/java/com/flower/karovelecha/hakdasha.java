...
public class hakdasha extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hakdasha);
...
//                                details[finalI].getText().toString().equals("נא לרשום את פנייתך"))
            ...
            public void onClick(View v) {
                ...
                for(EditText et : details)
                    if(et.getText()==null||et.getText().toString().equals("")) {
                        et.setText("שדה ריק");
                        Toast.makeText(hakdasha.this,"שדה ריק! אנא מלא את כל השדות, תודה!",Toast.LENGTH_SHORT).show();
                        return;
                    }

                pd=new ProgressDialog(hakdasha.this);
