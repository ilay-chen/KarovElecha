...
/**
 * Created by ilay on 03 יולי 2016.
 */
...
public class GeoTask extends AsyncTask<String, Void, List<String>> {
    ...
    @Override
    protected void onPostExecute(List<String> aDouble) {
        ...
        if(aDouble!=null)
        {
            ...
            //Toast.makeText(mContext, "ערכי מיקום שגויים, אנא בדוק שחיישן gps מאופשר", Toast.LENGTH_SHORT).show();
            geo1.GetDuration(null);
        }
    }
        ...
        try {
            ...
            if(statuscode== HttpURLConnection.HTTP_OK)
            {
                ...
                for(int i = 0; i < array_elements.length(); i++) {
                    ...
                    allDurations.add(object_duration.getString("value"));
